...
var _get_hiragana = function(txt){
  var ret = {};
...
var _get_katakana = function(txt){
  var chr = txt.substr(0,1);
  var t = hiragana2katakana[chr];
  var ret = {
    match: false,
    txt: txt.substring(1)
  };
...
var _conv = function(in_txt, get_func){
  var ret = {
    text:'',
    complete:false
  };
...
var conv = function(in_txt){
  return _conv(in_txt, _get_hiragana);
};

var katakana = function(in_txt){
  return _conv(in_txt, _get_katakana);
};
...
var hiragana2katakana = chr_convtbl.hiragana2katakana;
